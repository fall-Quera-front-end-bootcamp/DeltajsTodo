...
const QueraTaskManager = (): JSX.Element => {
  return (
    <section className="h-screen w-[340px] relative flex flex-col top-0 right-0 ml-auto bg-[#FFFFFF]">
      <div className="flex p-6 text-right flex-col justify-center items-center">
        {/* top text */}
        <div>
        ...
        <div className="flex flex-col">
            ...
            <form className="max-w-md mx-auto ">
              ...
              <div className="relative">
                ...
                <input
                  type="search"
                  id="default-search"
                  className="bg-[#F6F7F9] block w-full p-4 ps-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
          ...
          <div>
            ...
            <div className="flex flex-col">
              <div className="w-full flex justify-center items-center bg-gray-primary space-x-1 rounded-[6px]">

      ...
      <div className="flex flex-col items-center justify-center">
        ...
        <div className="mb-3 flex flex-col justify-end space-y-2 text-right">
          ...
          <div className="flex justify-between space-y-3">
            <div className="mb-[6px] mr-[4px] flex items-center justify-center">
              <div className="h-[21.85px] w-[23.85px] rounded-[67.8px] bg-yellow-secondary px-[5.42px] pb-[4.75px] pt-[6.1px] text-right text-[8.14px] font-medium text-yellow-primary">
                NM
              </div>
            </div>
        ...
        <div className="flex flex-col items-center space-y-2">
          <div className="h-[1px] w-[217px] bg-[#EFF0F0]"></div>
          <div className="flex items-center justify-between space-x-[150px]">
            <div>
              <svg
                width="20"
                height="20"

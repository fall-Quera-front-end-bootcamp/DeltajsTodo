...
const Checkbox = (): JSX.Element => {
  return (
    <div className="relative mt-1">
      <input
        className="focus:ring-blue-100 disabled:border-steel-400 disabled:bg-steel-400 peer
    relative size-4 shrink-0 cursor-pointer appearance-none rounded-[4px]
    border-[1px] border-gray-primary
    bg-white

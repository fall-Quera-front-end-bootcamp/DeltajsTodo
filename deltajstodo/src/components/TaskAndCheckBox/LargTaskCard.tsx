  ...
  return (
    ...
    >
      <div className="flex flex-col justify-center items-center">
        ...
        {/* -----------------body-------------------------- */}
        <div className="flex flex-col justify-end text-right space-y-2 mb-3">
          {/* -------------div 1--------------------------- */}
          <div className="flex justify-between space-y-3">
            <div className="flex justify-center items-center mb-[6px] mr-[4px]">
              <div className="h-[21.85px] w-[23.85px] rounded-[67.8px] pt-[6.1px] pb-[4.75px] pr-[5.42px] pl-[5.42px] bg-yellow-secondary text-yellow-primary font-medium text-[8.14px] text-right">
                NM
              </div>
            </div>
        ...
        <div className="flex flex-col items-center space-y-2">
          <div className="w-[217px] h-[1px] bg-[#EFF0F0]"></div>

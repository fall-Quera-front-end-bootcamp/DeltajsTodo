    ...
    <>
      <div className="bg-white h-[286px] w-[501px] rounded-lg p-[24px] flex flex-col items-center gap-[40px] shadow-[0_3px_4px_0] shadow-[#00000033]">
        <div className="bg-white h-[158px] w-[453px] flex flex-col items-center gap-[40px]">
          ...
          {/* colerPalet */}
          <div className="w-[453px] h-[86px]  flex flex-row gap-[16px]">
            <div
            ...
            >
              ...
              <div className="absolute w-[47px] h-[32px]  top-[17px] left-[11.5px]">
                <p className="  font-yekan w-[47px] h-[32px] text-center text-[24px] font-extrabold leading-[32px]  text-[#1E1E1E]">
                  ت ط
                </p>
              </div>
            </div>
            ...
            <div className="w-[293px] h-86px] flex flex-col gap-[16px]">
              ...
              {/*colores */}
              <div className="w-[293px] h-[50px] flex flex-col gap-[11px]">
                <div className="w-[293px] h-[50px] flex flex-wrap gap-[10px]">
        ...
        {/* ادامه*/}
        <div className="bg-white h-[40px] w-[415px] rounded-md    flex gap-[10px] ">
          <button
